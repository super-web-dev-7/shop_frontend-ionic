...
let RegisterPage = class RegisterPage {
    constructor(navCtrl, menuCtrl, loadingCtrl, formBuilder, httpRequest, auth) {
    ...
    ngOnInit() {
        this.onRegisterForm = this.formBuilder.group({
            ...
            'language': [{ value: null, disabled: true }, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([
                    _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required
                ])]
        });
    ...
    signUp() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            loader.onWillDismiss().then(() => {
                ...
                this.auth.register(data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])()).subscribe(data => {
                    this.goToLogin();
                }, error => {
